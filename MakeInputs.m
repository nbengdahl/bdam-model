...
mf6_parameters.uzf_nwavesets = 1000; % #User_Defined: MF6 UZF wave-set capacity for the full transient year
...
mf6_parameters.mean_forcing_spinup_years = 1; % #User_Defined: constant annual-mean forcing years, each using monthly steps
...
assert(all([mf6_parameters.mean_forcing_spinup_years, mf6_parameters.monthly_spinup_years, ...
    mf6_parameters.weekly_spinup_years] >= 0) && ...
    all(mod([mf6_parameters.mean_forcing_spinup_years, mf6_parameters.monthly_spinup_years, ...
