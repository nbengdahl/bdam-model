...
mf6_parameters.initial_head_channel_offset_m = 0.1; % #User_Defined: plane above downstream channel bottom [m]
...
assert(isfinite(mf6_parameters.initial_head_channel_offset_m) && ...
    mf6_parameters.initial_head_channel_offset_m >= 0, ...
    "Initial-head channel offset must be finite and nonnegative.");
...
mf6_parameters.initial_head_regional_slope_m_per_m = regional_longitudinal_slope;
...
function printReviewSummary(prep,calendar,slope)
    ...
    fprintf("  Initial-head plane: regional slope %.6g m/m; downstream channel offset %.6g m\n", ...
        prep.parameters.mf6_parameters.initial_head_regional_slope_m_per_m, ...
        prep.parameters.mf6_parameters.initial_head_channel_offset_m);
